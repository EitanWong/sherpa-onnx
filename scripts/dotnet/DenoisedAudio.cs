...
namespace SherpaOnnx
{
    public class DenoisedAudio : IDisposable
    {
        public DenoisedAudio(IntPtr p)
        {
            if (p == IntPtr.Zero)
            {
                throw new ArgumentNullException(nameof(p), "Denoised audio handle cannot be null.");
            }

            _handle = NativeResourceHandle.Create(p, SherpaOnnxDestroyDenoisedAudio);
        }
        ...
        private static void SherpaOnnxDestroyDenoisedAudio(IntPtr handle)
        {
            Dll.Invoke(
                () => NativeInternal.SherpaOnnxDestroyDenoisedAudio(handle),
                () => NativeExternal.SherpaOnnxDestroyDenoisedAudio(handle));
        }
        ...
        private static class NativeExternal
        {
            ...
            internal static extern void SherpaOnnxDestroyDenoisedAudio(IntPtr handle);
